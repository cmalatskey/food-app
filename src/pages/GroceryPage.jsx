...
function SectionHeader({ title, count, open, toggle, accent }) {
  return (
    <button onClick={toggle} className="flex items-center justify-between w-full mb-2">
      ...
      {open
        ? <ChevronUp size={16} className="text-[#a89080]" />
        : <ChevronDown size={16} className="text-[#a89080]" />}
    </button>
  );
}
